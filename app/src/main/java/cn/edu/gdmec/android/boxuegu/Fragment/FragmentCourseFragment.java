...
public class FragmentCourseFragment extends Fragment  {
    ...
    private RelativeLayout rl_abBanner;
    ...
    private void initView(View view){
        ...
        rl_abBanner=view.findViewById(R.id.rl_abBanner);
        ...
        vp_advertBanner.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position){
                dots.get(oldPoints).setBackgroundResource(R.drawable.indecator_off);
    ...
    private void resetSize(){
        ...
        int adLheight=sw/2;
        ViewGroup.LayoutParams adlp=rl_abBanner.getLayoutParams();
        adlp.width=sw;
        adlp.height=adLheight;
        rl_abBanner.setLayoutParams(adlp);
    }
